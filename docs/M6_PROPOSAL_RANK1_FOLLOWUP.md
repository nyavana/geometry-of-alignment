...
### 7.6 Stage 3 results (if reached)

*To be filled in. Format:*

| Sub-stage | Implementation | should_refuse n=12 | Notes |
|---|---|---|---|
| 3a (local norm-preserving biprojection) | `abliterate.py --norm-preserving` on D3 directions | | |
| 3b (faithful TrevorJS reproduction) | their repo, our hardware | | |
